<template>
	<aside :class="`${is_expanded ? 'is-expanded' : ''}`">
            ...
            prepend-avatar="https://static.vecteezy.com/system/resources/previews/019/896/008/original/male-user-avatar-icon-in-flat-design-style-person-signs-illustration-png.png"
            title="Hamza Abbas"
		...
		<div class="menu">
			...
			<router-link to="/Table" class="button">
				...
				<span class="text">View Database</span>
			</router-link>
			<router-link to="/action" class="button">
